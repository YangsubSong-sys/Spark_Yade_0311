#if !defined(AFX_MSFLEXGRID_H__34AD3BD0_5084_4BFA_8543_8FBA9A3D34C4__INCLUDED_)
#define AFX_MSFLEXGRID_H__34AD3BD0_5084_4BFA_8543_8FBA9A3D34C4__INCLUDED_
...
// Attributes
public:
	void SetRowColor(COLORREF ForeColor, COLORREF BackColor);
	void SetRowColor(int row, COLORREF ForeColor, COLORREF BackColor);
	void GetCurCell(int& row, int& col);
	void SetCurCell(int row, int col);
	void SetColColor(int col, COLORREF ForeColor, COLORREF BackColor);//sylee
...
#endif // !defined(AFX_MSFLEXGRID_H__34AD3BD0_5084_4BFA_8543_8FBA9A3D34C4__INCLUDED_)
